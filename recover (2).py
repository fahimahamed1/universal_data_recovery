...
class RecoveryApp:
    ...
    def style_ui(self):
        ...
        # Style configurations for a sleek modern look
        ...
        style.configure("Treeview.Heading",
                        font=("Arial", 11, "bold"),
                        background="#4d93c6",  # Light Blue Gradient
                        foreground="white")
        style.configure("TButton",
                        ...
                        padding=6,
                        width=12,
                        background="#4d93c6",  # Light Blue for buttons
                        foreground="white")
        style.map("TButton",
                  background=[("active", "#5ba8d6")],
        ...
        style.configure("TProgressbar",
                        thickness=30,
                        background="#4d93c6",  # Progress bar color
                        troughcolor="#d6e9f7")
    ...
    def build_controls(self):
        ...
        # Scan and Stop buttons with feedback
        self.scan_btn = ttk.Button(control_frame, text="Scan", command=self.start_scan, width=12, style="TButton")
        self.scan_btn.grid(row=0, column=0, padx=5)
        self.stop_btn = ttk.Button(control_frame, text="Stop", command=self.cancel_scan, width=12, state="disabled", style="TButton")
