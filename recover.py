...
class RecoveryApp:
    ...
    def build_controls(self):
        ...
        ttk.Button(control_frame, text="Scan", command=self.start_scan, width=12).grid(row=0, column=0, padx=5)
        ttk.Button(control_frame, text="Stop", command=self.cancel_scan, width=12).grid(row=0, column=1, padx=5)
